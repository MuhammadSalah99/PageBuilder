...
import CodeIcon from "../../../Components/Text-Editor/icons/CodeIcon";
import BoldIcon from "../../../Components/Text-Editor/icons/BoldIcon";
import ItalicIcon from "../../../Components/Text-Editor/icons/ItalicIcon";
import UnderlineIcone from "../../../Components/Text-Editor/icons/UnderlineIcone";
import StrikeThroughIcon from "../../../Components/Text-Editor/icons/StrikeThroughIcon";
import LinkIcon from "../../../Components/Text-Editor/icons/LinkIcon";
import { myStyles } from "../../../Components/Text-Editor/Config/constants";
...
function TextEditor() {
  ...
  const editor = useEditor({
    ...
    content:`Add Your Text here!` as HTMLContent,
    onUpdate(){
